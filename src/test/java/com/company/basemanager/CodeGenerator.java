...
public class CodeGenerator {
    ...
    private static final String AUTHOR = "libaogang"; //@author
    ...
    public static void generate(String moduleName,String tableName) {
        // 代码生成器
        ...
        strategy.setTablePrefix(moduleName + "_");  //表前缀，即模块名
