...
-- ----------------------------
INSERT INTO `schedule_job` VALUES (1, 'testTask', 'renren', '0 0/30 * * * ?', 0, '参数测试', '2019-09-22 16:33:03');
...
CREATE TABLE `sys_user`  (
  ...
  `update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更人者ID',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '超级管理员', '085de60f32b004402326e5ee425a6167', 1, '2016-11-11 11:11:11', 1, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (2, 'libaogang', '李宝刚', '1234567', 0, '2019-10-31 23:56:41', 1, '2019-11-01 00:02:04', 1, 0);
